...
INSERT INTO users (id, email, name, lastname, phone, password, active, new_user, user_type_id) SELECT 1, 'superadmin@sigser.com', 'SUPER', 'ADMIN', '0000000000', '$2a$10$ofdE1nUvF0GJh7kkISNBdeYM2WNX/uGWF30UgLXxl.PGo4n0gvZU.', TRUE, TRUE, 1 WHERE NOT EXISTS (SELECT 1 FROM users WHERE id = 1);
